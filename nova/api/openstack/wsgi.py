...
class ResponseObject(object):
    ...
    def _bind_meth_serializers(self, meth_serializers):
    ...
    def get_serializer(self, content_type, default_serializers={}):
    ...
    def serialize(self, request, content_type, default_serializers={}):
        ...
        if response is None:
            ...
            if resp_obj is not None:
                if self.serializer:
                    ...
                    resp_obj._bind_meth_serializers(serializers)
                    if hasattr(meth, 'wsgi_code'):
                        resp_obj._defcode = meth.wsgi_code
